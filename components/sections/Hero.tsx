      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        <div className="lg:col-span-7 space-y-12">
          ...
          <h1 className="text-7xl md:text-8xl lg:text-9xl font-display leading-[0.85] tracking-tighter animate-slam-in">
            ...
            BRUTAL<br/>
            <span className="text-lexis-green">RESULTS<span className="text-white">.</span></span>
          </h1>

          {/* Description */}
          <div className="max-w-xl border-l-2 border-lexis-green pl-8 py-2 animate-fade-in-up">
            <p className="text-lexis-grey text-lg font-mono leading-relaxed">
              We don't just practice law. We architect outcomes. LexisLaw provides elite legal strategy for those who demand excellence and clarity.
            </p>
          </div>
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 pt-12 border-t border-white/10 animate-fade-in-up">
            <div>
              <div className="font-display text-4xl text-white">15+</div>
              <div className="font-mono text-[10px] uppercase tracking-widest text-lexis-grey">Years Experience</div>
            </div>
            <div>
              <div className="font-display text-4xl text-white">500+</div>
              <div className="font-mono text-[10px] uppercase tracking-widest text-lexis-grey">Cases Won</div>
            </div>
            <div>
              <div className="font-display text-4xl text-white">24/7</div>
              <div className="font-mono text-[10px] uppercase tracking-widest text-lexis-grey">Support</div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 relative hidden lg:block">
          <div className="relative z-10 border-2 border-white/10 p-4 bg-lexis-black shadow-brutal-lg">
             <div className="aspect-[4/5] bg-lexis-dark-grey relative overflow-hidden grayscale contrast-125">
                ...
                <div className="absolute top-1/2 left-0 -translate-y-1/2 -rotate-90 origin-left">
                   <div className="bg-lexis-red text-white px-8 py-4 font-display text-4xl shadow-brutal-red">
                      EST. 1998
                   </div>
                </div>
             </div>
