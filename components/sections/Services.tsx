        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, idx) => (
            <Link key={idx} href={service.href} className="group">
              <Card 
                className={`h-full border-black/10 bg-black group-hover:border-lexis-red group-hover:shadow-brutal-red transition-all duration-300 border-l-4 ${service.color}`}
                padding="lg"
              >
                <div className="flex flex-col h-full justify-between gap-12">
                  <div className="space-y-6">
                    <div className="w-16 h-16 bg-white/5 flex items-center justify-center border-2 border-white/10 text-lexis-red group-hover:bg-lexis-red group-hover:text-black transition-colors duration-300 shadow-brutal">
                  ...
                  <div className="flex items-center gap-2 font-display text-sm tracking-widest text-lexis-red group-hover:text-white transition-colors mt-auto">
                    BOOK NOW <LucideArrowUpRight size={16} />
                  </div>
                </div>
              </Card>
            </Link>
