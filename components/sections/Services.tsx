        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-20">
          <div className="space-y-4">
            ...
            <h2 className="text-6xl md:text-8xl font-display tracking-tighter leading-none">
              SPECIALIZED<br/><span className="text-black/20">STRATEGY.</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, idx) => (
            <Link key={idx} href={service.href} className="group">
              <Card 
                className={`h-full border-black/5 bg-[#f4f4f4] group-hover:border-lexis-red group-hover:shadow-brutal-red transition-all duration-300 border-l-4 ${service.color}`}
                padding="lg"
              >
                <div className="flex flex-col h-full justify-between gap-12">
                  <div className="space-y-6">
                    <div className="w-16 h-16 bg-lexis-black/5 flex items-center justify-center border-2 border-black/5 text-lexis-red group-hover:bg-lexis-red group-hover:text-black transition-colors duration-300 shadow-brutal">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="font-mono text-xs text-[#333333] leading-relaxed group-hover:text-black/80 transition-colors">
                        {service.description}
                      </p>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-2 font-display text-sm tracking-widest text-black/50 group-hover:text-lexis-red transition-colors mt-auto">
